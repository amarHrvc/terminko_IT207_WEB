...
Flight::route('GET /customers', function(){
    ...
    */
    ...
    $allCustomers = Flight::examService()->get_customers();
    FLight::json($allCustomers);
...
Flight::route('GET /customer/meals/@customer_id', function($customer_id){
    ...
    * 10 points
    */
        $allmeals = Flight::examService()->get_customer_meals($customer_id);
    FLight::json($allmeals);
});
...
Flight::route('POST /customers/add', function() {
    ...
    */
    ...
    $allmeals = Flight::examService()->add_customer($data);
    Flight::json($allmeals);

    //  Flight::examService()->add_customer($customer_id);
});
